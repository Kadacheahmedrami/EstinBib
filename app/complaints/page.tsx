          ...
          <div className=" border  rounded-lg shadow-xl overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-400">
                    {title.length}/100 characters maximum
                  </p>
                </div>
            ...
            <div className=" px-6 py-4 sm:px-8 sm:py-5">
              <p className="text-xs text-gray-400">
                <span className="text-red-500 font-semibold">Note:</span> All submitted
                complaints are subject to review by our administrative team. We aim to 
