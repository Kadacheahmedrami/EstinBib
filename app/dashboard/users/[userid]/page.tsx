...
import { Shield, BookOpen, BadgeCheck, Clock, AlertTriangle, Pencil, ChevronLeft, Book, Calendar } from "lucide-react"
                    ...
                    <div className="space-y-3">
                      {borrowHistory
                        ...
                        .map(borrow => (
                          <div 
                            key={borrow.id} 
                            className={`flex items-center border p-3 rounded-lg ${borrow.isOverdue ? "border-red-300 bg-red-50 dark:border-red-700 dark:bg-red-900/20" : "border-gray-200 dark:border-gray-700"}`}
                          >
                            <div className="flex-shrink-0 mr-3">
                              <Image
                                src={borrow.bookCover || "/placeholder.svg"}
                            ...
                            <div className="flex-grow">
                              ...
                              <p className="text-sm text-gray-500 dark:text-gray-400">{borrow.bookAuthor}</p>
                              <div className="flex items-center text-sm mt-1">
                                <Clock className="h-3 w-3 mr-1" />
                                <span className={borrow.isOverdue ? "text-red-600 dark:text-red-400" : ""}>
