        ...
        <footer className="bg-gray-800 text-white py-12 px-6 lg:px-16 md:px-10" 
            ...
            <div className="flex flex-col md:flex-row justify-between items-start gap-8 space-y-6 md:space-y-0">
                ...
                <div className="flex flex-col items-start md:items-start text-center md:text-left space-y-9 w-full md:w-1/3">
                    ...
                    <a href="tel:+21334824916" className="text-[24px] text-[#F1413E] underline">+213-34-824-916</a>
                    </p>

                    <Link href="mailto:contact@estin.dz" className="text-[24px] text-[#F1413E] underline">contact@estin.dz</Link>
